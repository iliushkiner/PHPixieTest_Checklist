...
class Social extends Processor
{
    ...
    {
        //print_r($socialUser->loginData());        
        return (isset($socialUser->loginData()->name) ? $socialUser->loginData()->name : $socialUser->loginData()->last_name.' '.$socialUser->loginData()->first_name);
    }
