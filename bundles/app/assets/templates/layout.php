...
<head>
	...
	<title><?=$_($this->get('pageTitle', 'Checklist'))?></title>
</head>
<body>
...
<nav class="navbar navbar-toggleable-md navbar-light bg-faded">
	<div class="container">
            <a class="navbar-brand  mr-auto" href="<?=$this->httpPath('app.frontpage')?>"><img src="/bundles/app/logo.png"></a>
...
<!-- our own script file -->
<script src="/bundles/app/script.js"></script>
