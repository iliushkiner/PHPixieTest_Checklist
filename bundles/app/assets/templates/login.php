...
<div class="container content">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <?php $url = $this->httpPath('app.socialAuth', ['provider' => 'google']); ?>
            <a class="btn btn-lg btn-primary btn-block" href="<?=$url?>">Login with Google</a>
            
            <?php $url = $this->httpPath('app.socialAuth', ['provider' => 'vk']); ?>
            <a class="btn btn-lg btn-primary btn-block" href="<?=$url?>">Login with VK</a>
        </div>
